...
if (isset($_GET["moid"])){
    ...
    if (isset($_GET["view"])) { //if parent want to view moderator
//        $db->getModerator($_GET["view"]);
        header("location:../view/moderator.php?info=" . base64_encode(serialize($db->getModerator($_GET["view"]))));
    } else {
